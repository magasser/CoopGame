...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_USHealthComponent()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USHealthComponent_IsFriendly(), "IsFriendly"); // 3588122918
				...
				MetaData->SetValue(NewProp_TeamNum, TEXT("ModuleRelativePath"), TEXT("Public/Components/SHealthComponent.h"));
#endif
			}
		}
	...
	IMPLEMENT_CLASS(USHealthComponent, 3452925908);
